...
NOTES:
  ...
  - To prevent the deployed contract from being modified or deleted, it should not have any access
    keys on its account.
*/
// modified from near example NFT contract
...
pub struct Contract {
    ...
    allowed_minting_caller : Option<AccountId>,
}
...
impl Contract {
    ...
    #[init]
    #[allow(dead_code)]
    fn new_default_meta(owner_id: AccountId) -> Self {
        Self::new(
            owner_id,
            NFTContractMetadata {
                spec: NFT_METADATA_SPEC.to_string(),
    ...
    pub fn nft_mint(&mut self,token_id: TokenId,receiver_id: AccountId, token_metadata: TokenMetadata,
        ...
        self.allowed_minting_caller.clone().unwrap() != env::predecessor_account_id(){
            env::panic_str("Only cross-contract calling is allowed");
        }
